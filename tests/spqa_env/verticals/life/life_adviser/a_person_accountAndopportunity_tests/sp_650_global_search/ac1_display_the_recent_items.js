module.exports = {
    tags: ['spqa_sp_650_ac1', 'spqa_sp_650', 'sp_650', 'spqa_lifeadviser_sp650_ac1', 'spqa_lifeadviser_sp_650', 'lifeadviser_sp650'],
    ...
    'THEN the list of recent items will auto filter in the global search box': function (browser) 
    {
        search
            .waitForElementPresent('@recentItems', 30000 , function (result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/life/life_adviser/a_person_accountAndopportunity_tests/sp_650_global_search/ac1_display_the_recent_items.png')
                        .end();   
                }
                    else
                    {
