module.exports = {
    tags: ['spqa_sp_650_ac4', 'spqa_sp_650', 'sp_650', 'spqa_lifeadviser_sp650_ac4', 'spqa_lifeadviser_sp_650', 'lifeadviser_sp650'],
        ...
        search
            .waitForElementPresent('@selectedTab', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/life/life_adviser/a_person_accountAndopportunity_tests/sp_650_global_search/ac4_display_empty_results_page.png')
                        .end();
                }
                    else
                    {
