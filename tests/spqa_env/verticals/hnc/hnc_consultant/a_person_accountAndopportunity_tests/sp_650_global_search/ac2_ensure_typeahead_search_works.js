module.exports = {
    tags: ['spqa_sp_650_ac2', 'spqa_sp_650', 'sp_650', 'spqa_hncconsultant_sp650_ac2', 'spqa_hncconsultant_sp_650', 'hncconsultant_sp650'],
        ...
        .waitForElementVisible('@searchField', 3000 , function(result)
        {
            if (result.value)
            {
                search
                    ...
                    .pause(8000)
                browser
                    .saveScreenshot('reports/spqa_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac2_ensure_typeahead_search_works.png')
                search
