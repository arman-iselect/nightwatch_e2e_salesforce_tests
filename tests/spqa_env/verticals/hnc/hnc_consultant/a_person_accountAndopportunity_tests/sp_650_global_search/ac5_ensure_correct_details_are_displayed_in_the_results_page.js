module.exports = {
    tags: ['spqa_sp_650_ac5', 'spqa_sp_650', 'sp_650', 'spqa_hncconsultant_sp650_ac5', 'spqa_hncconsultant_sp_650', 'hncconsultant_sp650'],
        ...
        search
            .waitForElementVisible('@topResults', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac5_ensure_correct_details_are_displayed_in_the_results_page.png');
                    //Navigate to Leads
