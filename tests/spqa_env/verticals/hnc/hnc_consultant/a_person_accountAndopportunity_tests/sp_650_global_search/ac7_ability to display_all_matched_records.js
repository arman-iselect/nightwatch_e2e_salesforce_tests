module.exports = {
    tags: ['spqa_sp_650_ac7', 'spqa_sp_650', 'sp_650', 'spqa_hncconsultant_sp650_ac7', 'spqa_hncconsultant_sp_650', 'hncconsultant_sp650'],
    ...
    {   
        ...
        .waitForElementPresent('@pageResult', 30000, function (result)
        {
            if (result.value)
            {
                ...
                browser
                    .saveScreenshot('reports/spqa_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac7_ability to display_all_matched_records.png')            
                    .end(); 
            }
                else
                {
