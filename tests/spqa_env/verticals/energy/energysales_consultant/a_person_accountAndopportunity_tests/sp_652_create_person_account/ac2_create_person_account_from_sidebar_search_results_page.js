module.exports = {
    tags: ['spqa_sp_652_ac2', 'spqa_sp_652', 'sp_652', 'spqa_energysales_sp652_ac2', 'spqa_energysales_sp_652', 'energysales_sp652'],
            ...
            .waitForElementPresent('@sidebarResults', 15000, function(result)
                {
                    if (result.value)
                    {
                        browser
                            ...
                            .pause(3000)
                        browser
                            .saveScreenshot('reports/spqa_env/verticals/energy/energysales_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2b_create_person_sidebar_result_page.png')
                    }
                        else
                            {
        ...
        account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/energy/energysales_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2a_create_person_sidebar_result_page.png')
                }
                    else
                    {
                        console.log
