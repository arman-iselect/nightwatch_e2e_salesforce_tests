module.exports = {
    tags: ['spqa_sp_652_ac1', 'spqa_sp_652', 'sp_652', 'spqa_energytelco_sp_652_ac1', 'spqa_energytelco_sp_652', 'energytelco_sp_652'],
    ...
    'AND I shall be able to view the person account page tab as a default': function(browser)
    {
        account
            .waitForElementVisible('@tabPresent', 15000, function(result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac1a_create_person_record.png')
                }
                    else
                    {
                        console.log('Refreshing the Page')
        ...
        account
            .waitForElementVisible('@personaccountTitle', 20000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac1b_create_person_record.png')
                    account
                        .click_closeTab();
                }
                    else
    ...
    'OTHERWISE if there are mandatory fields not populated, an error message shall be displayed AND I shall not be able to proceed any further': function(browser)
    {
        ...
        account
            ...
            .pause(5000)
        browser
            .saveScreenshot('reports/spqa_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac1c_create_person_record.png')
        account
            .click_closenewTab();
    }
};