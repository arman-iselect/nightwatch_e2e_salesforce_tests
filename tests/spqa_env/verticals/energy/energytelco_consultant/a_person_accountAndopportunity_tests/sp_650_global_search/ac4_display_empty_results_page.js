module.exports = {
    tags: ['spqa_sp_650_ac4', 'spqa_sp_650', 'sp_650', 'spqa_energytelco_sp650_ac4', 'spqa_energytelco_sp_650', 'energytelco_sp650'],
        ...
        search
            .waitForElementPresent('@selectedTab', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac4_display_empty_results_page.png')
                        .end();
                }
                    else
                    {
