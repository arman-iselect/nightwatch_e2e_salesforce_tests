module.exports = {
    tags: ['spqa_sp_652_ac2', 'spqa_sp_652', 'sp_652', 'spqa_giconsultant_sp_652_ac2', 'spqa_giconsultant_sp_652', 'giconsultant_sp_652'],
            ...
            .waitForElementPresent('.iframe-parent > iframe:nth-child(1)', 30000, function(result)
            {
                if (result.value)
                {
                    browser
                        ...
                        .frame(0)
                    account
                        .setValue('@inputfirstName', energy.gi.account_info.first_name)
                        .setValue('@inputEmail', energy.gi.account_info.email)
                    browser
            ...
            .waitForElementPresent('@sidebarResults', 15000, function(result)
                {
                    if (result.value)
                    {
                        browser
                            ...
                            .pause(3000)
                        browser
                            .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2b_create_person_sidebar_result_page.png')
                    }
                        else
                            {
    ...
    'WHEN I have entered at least the Last Name (optionally First Name, Phone Number, and Email Address) and hit the Save button': function (browser) 
    {
       browser
            .useXpath().waitForElementPresent('/html/body/form/div[1]/div[1]/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]/input', 15000, function(result)
            {
                ...
                {
                    browser
                        .useXpath().setValue('/html/body/form/div[1]/div[1]/div/div/div/div[2]/div/div/table/tbody/tr[1]/td[2]/input', energy.gi.account_info.last_name)
                    browser
                        .useXpath().click('/html/body/form/div[2]/div/div[2]/div/table/tbody/tr[10]/td[1]/a[1]/i/b')
                }
                    else
            ...
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    account
                        ...
                        .verify.containsText('@personaccountName',energy.gi.account_info.account_name, 'Person account name is displayed correctly ?')
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2a_create_person_sidebar_result_page.png')
                }
                    else
                    {
                        console.log
