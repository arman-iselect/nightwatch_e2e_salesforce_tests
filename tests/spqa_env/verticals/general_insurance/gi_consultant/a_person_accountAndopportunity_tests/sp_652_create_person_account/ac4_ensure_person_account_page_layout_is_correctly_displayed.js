module.exports = {
    tags: ['spqa_sp_652_ac4', 'spqa_sp_652', 'sp_652', 'spqa_giconsultant_sp_652_ac4', 'spqa_giconsultant_sp_652', 'giconsultant_sp_652'],
       ...
       account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac4a_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_activityTab()
                    ...
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac4b_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_closeTab();
                }
                    else
