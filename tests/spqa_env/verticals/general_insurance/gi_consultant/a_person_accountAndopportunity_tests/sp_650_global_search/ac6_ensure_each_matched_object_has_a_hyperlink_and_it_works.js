module.exports = {
    tags: ['spqa_sp_650_ac6', 'spqa_sp_650', 'sp_650', 'spqa_giconsultant_sp650_ac6', 'spqa_giconsultant_sp_650', 'giconsultant_sp650'],
    ...
    {   
        search
            .waitForElementVisible('@profileWrap', 25000 , function(result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac6_ensure_each_matched_object_has_a_hyperlink.png')
                        .end();
                }
                    else
                        {
