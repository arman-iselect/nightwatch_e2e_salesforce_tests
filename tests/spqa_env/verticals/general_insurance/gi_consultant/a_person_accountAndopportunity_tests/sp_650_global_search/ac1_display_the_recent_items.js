module.exports = {
    tags: ['spqa_sp_650_ac1', 'spqa_sp_650', 'sp_650', 'spqa_giconsultant_sp650_ac1', 'spqa_giconsultant_sp_650', 'giconsultant_sp650'],
    ...
    'THEN the list of recent items will auto filter in the global search box': function (browser) 
    {
        search
            .waitForElementPresent('@recentItems', 30000 , function (result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/spqa_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac1_display_the_recent_items.png')
                        .end();   
                }
                    else
                    {
