       ...
       account
        .waitForElementVisible('@selectedTab', 30000, function (result)
        {
            if (result.value)
            {
                ...
                browser
                    .saveScreenshot('reports/spqa_env/verticals/telco/telco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac5_ensure_correct_details_displayed_account_page.png')
                account
                    .click_closeTab();
            }
                else
