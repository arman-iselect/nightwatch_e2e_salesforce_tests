module.exports = {
    tags: ['spqa_sp_650_ac2', 'spqa_sp_650', 'sp_650', 'spqa_telcoconsultant_sp650_ac2', 'spqa_telcoconsultant_sp_650', 'telcoconsultant_sp650'],
        ...
        .waitForElementVisible('@searchField', 3000 , function(result)
        {
            if (result.value)
            {
                search
                    ...
                    .pause(8000)
                browser
                    .saveScreenshot('reports/spqa_env/verticals/telco/telco_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac2_ensure_typeahead_search_works.png')
                search
