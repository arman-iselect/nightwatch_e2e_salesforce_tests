module.exports = {
    tags: ['bat_sp_650_ac6', 'bat_sp_650', 'sp_650','bat_energytelco_sp_650_ac6', 'bat_energytelco_sp_650', 'energytelco_sp_650'],
    ...
    {   //Verify top results page is displayed
        search
            .waitForElementVisible('@profileWrap', 25000 , function(result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac6_ensure_each_matched_object_has_a_hyperlink.png')
                        .end();
                }
                    else
                        {
