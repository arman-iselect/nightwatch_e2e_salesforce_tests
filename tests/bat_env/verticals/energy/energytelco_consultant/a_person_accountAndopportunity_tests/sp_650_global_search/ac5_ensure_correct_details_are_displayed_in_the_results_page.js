module.exports = {
    tags: ['bat_sp_650_ac5', 'bat_sp_650', 'sp_650','bat_energytelco_sp_650_ac5', 'bat_energytelco_sp_650', 'energytelco_sp_650'],
        ...
        search
            .waitForElementVisible('@topResults', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac5_ensure_correct_details_are_displayed_in_the_results_page.png');
                    //Navigate to Leads
