module.exports = {
    tags: ['bat_sp_652_ac3', 'bat_sp_652' , 'sp_652','bat_energytelco_sp_652_ac3', 'bat_energytelco_sp_652', 'energytelco_sp_652'],
       ...
       account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac3a_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_activityTab()
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energytelco_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac3b_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_telcocloseTab();
                }
                    else
