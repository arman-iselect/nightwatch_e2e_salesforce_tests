module.exports = {
    tags: ['bat_sp_650_ac3','bat_sp_650', 'sp_650','bat_energysales_sp_650_ac3', 'bat_energysales_sp_650', 'energysales_sp_650'],
        ...
        search
            .waitForElementPresent('@primaryObjects', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energysales_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac3_display_search_results_page.png')
                        .end();
                }
                    else
                    {
