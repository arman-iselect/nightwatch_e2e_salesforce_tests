            ...
            .waitForElementPresent('@sidebarResults', 15000, function(result)
                {
                    if (result.value)
                    {
                        browser
                            ...
                            .pause(3000)
                        browser
                            .saveScreenshot('reports/bat_env/verticals/energy/energysales_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2b_create_person_record.png')
                    }
                        else
                            {
        ...
        account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/energy/energysales_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac2a_create_person_record.png')
                }
                    else
                    {
                        console.log
