    ...
    'THEN the list of recent items will auto filter in the global search box': function (browser) 
    {
        search
            .waitForElementVisible('@recentItems', 30000 , function (result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/bat_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac1_display_the_recent_items.png')
                        .end();   
                }
                    else
                    {
