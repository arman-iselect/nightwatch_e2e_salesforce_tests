module.exports = {
    tags: ['bat_sp_650_ac4', 'bat_sp_650', 'sp_650','bat_hncconsultant_sp_650_ac1', 'bat_hncconsultant_sp_650', 'hncconsultant_sp650'],
        ...
        search
            .waitForElementPresent('@selectedTab', 10000 , function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac4_display_empty_results_page.png')
                        .end();
                }
                    else
                    {
