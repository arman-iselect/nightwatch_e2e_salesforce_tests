module.exports = {
    tags: ['bat_sp_652_ac1', 'bat_sp_652' , 'sp_652','bat_hncconsultant_sp_652_ac3', 'bat_hncconsultant_sp_652', 'hncconsultant_sp652'],
            ...
            .waitForElementVisible('@detailsTab', 20000, function (result)
            {
                if (result.value)
                {
                    ...
                    account
                        ...
                        .pause(2000)
                    browser
                        .saveScreenshot('reports/bat_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac3a_update_person_account_information.png')
                    account
                        .click_detailsSave()
                        .pause(5000);
                }
        ...
        account
            .waitForElementVisible('@detailsTab', 15000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac3b_update_person_account_information.png')
                }
                    else
                    {
            ...
            .waitForElementVisible('@detailsTab', 20000, function (result)
        {
            if (result.value)
            {
                ...
                account
                    ...
                    .pause(5000);
                browser
                    .saveScreenshot('reports/bat_env/verticals/hnc/hnc_consultant/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac3c_update_person_account_information.png')
                account
                    .click_closeTab()
