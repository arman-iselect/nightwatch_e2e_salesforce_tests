module.exports = {
    tags: ['bat_sp_650_ac2', 'bat_sp_650' , 'sp_650','bat_giconsultant_sp_650_ac1', 'bat_giconsultant_sp_650', 'giconsultant_sp650'],
            ...
            .waitForElementVisible('@searchField', 3000 , function(result)
            {
                if (result.value)
                {
                    search
                        ...
                        .pause(8000)
                    browser
                        .saveScreenshot('reports/bat_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac2_ensure_typeahead_search_works.png')
                    search
