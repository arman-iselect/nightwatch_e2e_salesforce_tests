module.exports = {
    tags: ['bat_sp_650_ac7', 'bat_sp_650', 'sp_650','bat_giconsultant_sp_650_ac1', 'bat_giconsultant_sp_650', 'giconsultant_sp650'],
        ...
        search
            .waitForElementPresent('@pageResult', 30000, function (result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/general_insurance/gi_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac7_ability to display_all_matched_records.png')            
                        .end(); 
                }
                    else
                    {
