module.exports = {
    tags: ['bat_sp_650_ac6', 'bat_sp_650', 'sp_650','bat_telcoconsultant_sp_650_ac1', 'bat_telcoconsultant_sp_650', 'telcoconsultant_sp650'],
    ...
    {   //Verify top results page is displayed
        search
            .waitForElementVisible('@profileWrap', 25000 , function(result)
            {
                ...
                {
                    browser
                        .saveScreenshot('reports/bat_env/verticals/telco/telco_consultant/a_person_accountAndopportunity_tests/sp_650_global_search/ac6_ensure_each_matched_object_has_a_hyperlink.png')
                        .end();
                }
                    else
                        {
