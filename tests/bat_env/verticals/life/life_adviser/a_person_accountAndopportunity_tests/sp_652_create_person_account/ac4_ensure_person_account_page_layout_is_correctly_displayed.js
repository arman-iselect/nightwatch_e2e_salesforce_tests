       ...
       account
            .waitForElementVisible('@selectedTab', 30000, function(result)
            {
                if (result.value)
                {
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/life/life_adviser/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac4a_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_activityTab()
                    ...
                    browser
                        .saveScreenshot('reports/bat_env/verticals/life/life_adviser/a_person_accountAndopportunity_tests/sp_652_create_person_account/ac4b_ensure_person_account_page_layout_displayed_correctly.png')
                    account
                        .click_closeTab();
                }
                    else
